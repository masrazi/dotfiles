...
do
   ...
   #dispstr="$dispstr$(dwm_loadavg)"
    ...
    xsetroot -name "^c#0B622E^^b#4DB9B1^ $(dwm_battery) ^c#FF8A65^^b#5D4037^ $(dwm_memory) ^c#fcf7ff^^b#1A237E^ $(dwm_backlight)^c#424242^^b#A5D6A7^$(dwm_alsa) ^c#67FFFB^^b#00587a^ $(dwm_networkmanager) ^c#022835^^b#50A162^ $(dwm_date)"
    sleep 1
